...
public class DbUserInsert {
    ...
    public void 관리자등록() {
        ...
        while(iteratorHm.hasNext()){
            ...
            assertThat(findUser.getUserId()).isEqualTo(keyValue.getUserId());
        }
    }
    ...
    public void 사장님등록BBQ불당() {
        ...
        // then
        assertThat(findStoreMst.getSeq()).isEqualTo(saveSeq);
        assertThat(findStoreMst.getFranchiseMst().getSeq()).isEqualTo(franchiseMst.getSeq());
        assertThat(findStoreMst.getFranchiseMst().getFranchiseName()).isEqualTo(franchiseMst.getFranchiseName());
        assertThat(findStoreMst.getUserMst().getSeq()).isEqualTo(userMst.getSeq());
    }
